...
import com.krawart.hexademo.core.supply.domain.Order.OrderItem;
import com.krawart.hexademo.core.supply.presentation.rest.v1.dto.MedicineDTO.MedicineShortDTO;
...
public record OrderDTO(String id, String name, List<OrderItemDTO> medicines) {
    ...
    public record OrderItemDTO(MedicineShortDTO medicine, Integer quantity) {
